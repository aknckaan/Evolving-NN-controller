function [ poses, sensations, actions, states ] = assignmentSimulation(controlFunction,orientation, varargin)
...
%just for training 
	...
	% initialise agent
	poses(1,:) = [ 0, 0, orientation ]; % start at origin, given orientation	
	...
	for t = 0:dt:duration
        ...
        controlFunction.setLocation(xy(1),xy(2),theta);
